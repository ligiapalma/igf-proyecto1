        ...
        <div class="page-header clear-filter" filter-color="purple">
            <div class="page-header-image" data-parallax="true" style="background-image: url('img/full-screen-image-3.jpg')">
                ...
                <div class="title-container text-center">
                    <h1>Médicos en Línea</h1>
                    <h3>Consulta con un doctor en línea los 365 días</h3>
                    <h4 class="description text-center">Más de 200 Expertos</h4>
                    <br />
                    <a href="{{ route('register') }}" class="btn btn-round btn-neutral btn-fill" target="_blank">¡Registrate!</a>
                </div>
            </div>
        </div>
    </div>
